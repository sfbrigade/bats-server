...
async function addRingdown(data) {
  ...
  await models.sequelize.transaction(async (transaction) => {
    await createRingdown(email, ambulanceIdentifier, hospitalName, dispatchCallNumber, patientData, deliveryStatus, etaMinutes, transaction);
  });
}
