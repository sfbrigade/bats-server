...
// adapted to CJS from https://github.com/sindresorhus/fnv1a
...
module.exports = function getFileHash(path) {
  return String(fnv1a(readFileSync(path, 'utf8')));
};
