...
const ValidationMessage = ({ validationState }) => {
  const errorHtml = <span className='usa-error-message'><i className="fas fa-exclamation-circle" /> This is a required section</span> 
  const successHtml = <span className='usa-success-message'><i className="fas fa-check-circle" /> Success</span> 
